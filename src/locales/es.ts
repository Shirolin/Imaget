export default {
  ...
  prefFollowScanHint: {
    message:
      "Añade automáticamente a la lista las imágenes que se carguen mientras la ventana del plugin está abierta",
  },
  prefGifHandling: {
  ...
  prefHideDownloadWarningHint: {
    message:
      "Las descargas comienzan directamente cuando hay más de 30 imágenes seleccionadas. Los avisos de permiso del navegador para descargas múltiples no se ven afectados.",
  },
