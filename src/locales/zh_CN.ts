export default {
  ...
  descDisabledDomains: {
    message: "悬浮按钮将不会在以下网站显示",
  },
  descFilterDefaults: {
    message:
      "在此设置的默认值将在插件启动时自动应用，并在手动重置筛选器时恢复。修改后会立即同步到当前筛选状态。",
  },
  deselectAll: {
    message: "取消全选",
  },
  ...
  extDesc: {
    message: "智能嗅探网页图片，支持一键批量下载及格式转换。",
  },
  extName: {
    message: "Imaget - 智能图片嗅探与下载",
  },
  filterExclude: {
    message: "排除词 (空格分隔)",
  },
  ...
  prefFollowScanHint: {
    message: "插件窗口打开时，页面滚动或懒加载出新图片后自动补充到列表",
  },
  prefGifHandling: {
    message: "GIF 处理策略",
  },
  ...
  prefHideDownloadWarningHint: {
    message:
      "超过 30 张图片时直接开始下载。浏览器的多文件下载权限提示不受此设置影响。",
  },
  ...
  prefIdentifyBlobImagesHint: {
    message:
      "对 Telegram 等加密聊天，在网页中点击图片进入大图预览模式即可自动且瞬间嗅探捕获其最高清原图尺寸。",
  },
  prefLanguage: {
    message: "界面语言",
  },
