export default {
  ...
  downloadSelected: {
    message: "선택 항목 다운로드 ($1)",
  },
  downloadZip: {
    message: "ZIP 다운로드",
  },
  exploringImages: {
    message: "페이지에서 이미지 탐색 중...",
  },
  extDesc: {
    message: "모든 웹페이지에서 이미지를 자동으로 찾아 일괄 다운로드합니다.",
  },
  extName: {
    message: "Imaget - 스마트 이미지 스니퍼 및 다운로더",
  },
  filterExclude: {
    message: "제외 키워드",
  },
  ...
  hintClick: {
    message: "배경 클릭: 미리보기 닫기",
  },
  hintDrag: {
    message: "왼쪽 클릭 드래그: 이미지 이동",
  },
  hintWheel: {
    message: "휠: 이미지 확대/축소",
  },
  ...
  prefFollowScanHint: {
    message:
      "플러그인 창이 열려 있는 동안 새로 로드된 이미지를 자동으로 목록에 추가합니다",
  },
  prefGifHandling: {
    message: "GIF 처리",
  },
  prefHideDownloadWarning: {
    message: "앱 내 일괄 다운로드 확인 건너뛰기",
  },
  prefHideDownloadWarningHint: {
    message:
      "이미지를 30장 넘게 선택하면 바로 다운로드를 시작합니다. 브라우저의 다중 다운로드 권한 안내에는 영향을 주지 않습니다.",
  },
  ...
  prefIdentifyBlobImagesHint: {
    message:
      "Telegram 등 암호화된 채팅의 경우, 웹페이지에서 이미지를 클릭하여 원본 미리보기 모드로 들어가면 가장 해상도가 높은 원본 이미지를 자동으로 즉시 감지하여 캡처할 수 있습니다.",
  },
  prefLanguage: {
    message: "인터페이스 언어",
  },
  ...
  prefMinImageSize: {
    message: "플로팅 버튼 최소 크기",
  },
  prefQuality: {
    message: "품질",
  },
  prefReEncodeWebp: {
    message: "WebP 강제 재인코딩",
  },
  prefSave: {
    message: "저장",
  },
  prefSearchAllFrames: {
    message: "모든 프레임 스캔 (iFrame)",
  },
  prefShowHoverBtn: {
    message: "플로팅 버튼 표시",
  },
  ...
  prefSimulateDownloadFailure: {
    message: "다운로드 실패 시뮬레이션",
  },
  prefSubfolder: {
    message: "하위 폴더",
  },
  prefSubfolderHint: {
    message: "다운로드 디렉토리의 이 폴더에 저장됩니다",
  },
  ...
  resModeAndDesc: {
    message: "가로와 세로 모두 일치",
  },
  resModeOr: {
    message: "OR",
  },
  resModeOrDesc: {
    message: "가로 또는 세로 중 하나만 일치",
  },
  resetAllSettings: {
    message: "모든 설정 재설정",
  },
  ...
  toastDownloadStarted: {
    message: "$1 개의 이미지 다운로드를 시작했습니다",
  },
  toastNoSelection: {
    message: "먼저 이미지를 선택하세요",
  },
  unitPixel: {
    message: "$1px+",
  },
  ...
  viewVariables: {
    message: "사용 가능한 변수 보기",
  },
  warnManyFiles: {
    message: "$1 개의 이미지를 다운로드하시겠습니까?",
  },
  warnResetAll: {
