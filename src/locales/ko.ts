export default {
  ...
  filterType: { message: "유형" },
  filterExcludeType: { message: "제외할 유형" },
  ...
  prefDefaultExcludeKeywords: { message: "기본 제외 키워드" },
  prefDefaultSearchQuery: { message: "기본 검색어" },
  prefDefaultAllowedFormats: { message: "기본 허용 형식" },
  prefDefaultExcludeFormats: { message: "기본 제외 형식" },
  prefDefaultAspectRatio: { message: "기본 가로세로 비율" },
  prefDefaultResolutionMode: { message: "기본 해상도 모드" },
