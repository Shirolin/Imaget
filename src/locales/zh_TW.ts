export default {
  ...
  "descDisabledDomains": {
    "message": "懸浮按鈕將不會在以下網站顯示"
  },
  "descFilterDefaults": {
    "message": "外掛啟動或重置篩選時將優先使用的預設值"
  },
  "deselectAll": {
    "message": "取消全選"
  },
  ...
  "extDesc": {
    "message": "智能嗅探網頁圖片，支持一鍵批量下載及格式轉換。"
  },
  "extName": {
    "message": "Imaget - 智能圖片嗅探與下載"
  },
  "filterExclude": {
    "message": "排除詞 (空格分隔)"
  },
  ...
  "prefFollowScanHint": {
    "message": "外掛視窗開啟時，頁面捲動或懶載入出新圖片後自動補充到列表"
  },
  "prefGifHandling": {
    "message": "GIF 處理策略"
  },
  ...
  "prefHideDownloadWarningHint": {
    "message": "超過 30 張圖片時直接開始下載。瀏覽器的多文件下載權限提示不受此設定影響。"
  },
  ...
  "warningWebEnvironment": {
    "message": "注意：當前檢測為純網頁環境。受瀏覽器安全限制，子目錄及重命名佔位符功能可能無法在當前預覽模式下生效，請安裝並注入插件後測試完整功能。"
  }
};
